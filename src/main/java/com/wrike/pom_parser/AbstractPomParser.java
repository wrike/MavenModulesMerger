...
import com.wrike.pom_parser.bean.Dependency.DependencyBuilder;
...
import static com.wrike.pom_parser.bean.DependencyScope.getScopeByName;
import static com.wrike.pom_parser.utils.XmlUtils.*;
...
public abstract class AbstractPomParser implements PomParser {
    ...
    public String getArtifactId() {
        return getNodeByXPath(document, ARTIFACT_ID_PATH).getTextContent();
    }
